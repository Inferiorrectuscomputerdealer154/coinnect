...
REMITLY_CORRIDORS: list[tuple] = [
    ...
    ("USD", "ETB",  2.80, 1440,  "Remitly — cash pickup or bank deposit, Ethiopia"),
...
WORLDREMIT_CORRIDORS: list[tuple] = [
    ...
    ("USD", "ETB",  3.50, 1440,  "WorldRemit — bank deposit or cash pickup, Ethiopia"),
...
XE_CORRIDORS: list[tuple] = [
    ...
    ("USD", "ETB",  2.50, 1440, "XE Money Transfer — bank wire to Ethiopia"),
...
WESTERN_UNION_CORRIDORS: list[tuple] = [
    ...
    ("USD", "ETB",  5.80, 1440,  "Western Union — cash pickup or bank, Ethiopia"),
...
MONEYGRAM_CORRIDORS: list[tuple] = [
    ...
    ("USD", "ETB",  6.00, 1440,  "MoneyGram — cash pickup or bank, Ethiopia"),
